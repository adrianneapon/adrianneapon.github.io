...
<div class="main-body-wrapper portfolio" id="main-body-wrapper">  
    ...
    <div class="title"><p class="poppins-22 semibold">Portfolio</p></div>
                      
    <div class="tab-pane">
        <p class="poppins-14 active" id="uidesign">UI/UX & WEB DESIGN</p>
        <p class="poppins-14" id="webdesign">WEB DESIGN WITH CMS</p>
    </div>
